...
export default function PastriesPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-4">Pastries</h1>
        <p className="text-gray-600 text-lg">Freshly baked croissants, danishes, and more delicious pastries</p>
      </div>
      ...
      {sorted.length === 0 ? (
        <div className="text-center py-8">
          <p className="text-gray-500">No pastries available.</p>
        </div>
      ) : (
              ...
              <Card key={product.id} className="overflow-hidden transition-all hover:shadow-lg">
                ...
                <CardHeader className="p-4 pb-0">
                  <div className="flex justify-between items-start">
                    <span className="text-xs text-amber-600 font-medium uppercase tracking-wide">Pastries</span>
